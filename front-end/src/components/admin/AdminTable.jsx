    ...
    <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
      ...
      <div className="px-4 sm:px-6 py-4 sm:py-5 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50 flex items-center justify-between">
        <h3 className="text-base sm:text-lg font-bold text-gray-900 flex items-center gap-2">
          ...
          <span className="hidden sm:inline">{t("admins.list.title")}</span>
          <span className="sm:hidden">{t("admins.list.title")}</span>
      ...
      {admins.length === 0 && (
        <div className="py-12 text-center">
          ...
          <p className="text-gray-500 text-sm">{t("no_data") || "Aucun administrateur trouvé"}</p>
        </div>
      )}
    </div>
  );
