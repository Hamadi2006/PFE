  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        setLastActivitys([...lastActivitys, { date: new Date(), action: "Modifier l'administrateur : " + formData.nom + " " + formData.prenom }]);
          ...
          <div className="mb-6">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-4">
              <p className="text-sm text-amber-800">
                <strong>{t("updateAdmin.note")}:</strong>{" "}
                {t("updateAdmin.passwordNote")}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                >
                  ...
                  <option value="Sous_administrateur">
                    {t("updateAdmin.roles.subAdmin")}
                  </option>
                </select>
              </div>
                ...
                <label className="flex items-center cursor-pointer">
                  ...
                  <div className="ml-3">
                    <span className="text-sm font-medium text-gray-700">
                      {t("updateAdmin.account")}{" "}
                      {formData.actif
                        ? t("updateAdmin.active")
                        : t("updateAdmin.inactive")}
                    </span>
                    <p className="text-xs text-gray-500">
                      {formData.actif
                        ? t("updateAdmin.canLogin")
                        : t("updateAdmin.cannotLogin")}
                    </p>
                  </div>
                </label>
              </div>
