...
import { Plus, X, Eye, Edit, Trash2, Building2, Mail, Lock, Phone, MapPin, Globe, Upload } from "lucide-react";

// Child component: AddCompanyModal
  ...
  return (
    <div className="fixed inset-0 bg-gray-900/30 backdrop-blur-md flex items-center justify-center z-50 p-4">
      <div className="bg-white/90 backdrop-blur-xl rounded-2xl w-full max-w-xl shadow-2xl border border-white/40 overflow-hidden max-h-[90vh] flex flex-col">
        ...
        <div className="bg-gradient-to-r from-cyan-600/90 to-blue-600/90 backdrop-blur-sm px-6 md:px-8 py-6 relative border-b border-white/20">
          <button
          ...
          <div className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-3 py-2.5 border rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all ${
                      errors.nom ? "border-red-400 bg-red-50" : "border-gray-300 bg-gray-50 focus:bg-white"
                    }`}
                    placeholder="Nom de la société"
                  />
                </div>
                {errors.nom && <p className="text-red-500 text-xs mt-1.5 flex items-center gap-1">⚠ {errors.nom}</p>}
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full pl-10 pr-3 py-2.5 border border-gray-300 bg-gray-50 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent focus:bg-white transition-all"
            ...
            <div className="flex gap-3 pt-4 border-t border-gray-200">
              <button
                type="button"
                onClick={() => setShowModal(false)}
                className="flex-1 px-4 py-3 border-2 border-gray-300 text-gray-700 rounded-lg font-semibold hover:bg-gray-50 transition-all text-base md:text-lg"
              >
                Annuler
              </button>
              <button
                ...
                className="flex-1 bg-gradient-to-r from-cyan-600 to-blue-600 text-white px-4 py-3 rounded-lg font-semibold hover:from-cyan-700 hover:to-blue-700 shadow-lg hover:shadow-xl transition-all text-base md:text-lg"
              >
                Ajouter
              </button>
            </div>
