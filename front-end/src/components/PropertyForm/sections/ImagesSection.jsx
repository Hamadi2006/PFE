  ...
  return (
    <div className="mb-6">
      <h4 className="text-lg font-semibold text-slate-800 mb-4">
        {t('properties2.sections.images')}
      </h4>
      <div className="grid grid-cols-1 gap-4">
        <FormFileUpload
          label={t('properties2.fields.image_principale')}
        ...
        <FormFileUpload
          label={t('properties2.fields.images_supplementaires')}
          name="images"
          ...
          note={t('properties2.fields.images_note')}
        />
      </div>
    </div>
  );
